...
-- 20 Demo Nodes
-- ============================================================
INSERT INTO nodes (id, url, text_content, title, thumbnail_key, owner_id, language_code, origin_user_id, origin_created_at, deleted_at, created_at, node_type) VALUES
  ('10000000-0000-0000-0000-000000000001'::uuid, 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', NULL, 'Never Gonna Give You Up',       NULL, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'en', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, now() - interval '20 days', NULL, now() - interval '20 days', 'video'),
  ('10000000-0000-0000-0000-000000000002'::uuid, 'https://www.youtube.com/watch?v=9bZkp7q19f0', NULL, 'Gangnam Style',                 NULL, 'b2c3d4e5-f6a7-8901-bcde-f12345678901'::uuid, 'en', 'b2c3d4e5-f6a7-8901-bcde-f12345678901'::uuid, now() - interval '19 days', NULL, now() - interval '19 days', 'video'),
  ('10000000-0000-0000-0000-000000000003'::uuid, 'https://www.youtube.com/watch?v=kJQP7kiw5Fk', NULL, 'Despacito',                     NULL, 'c3d4e5f6-a7b8-9012-cdef-123456789012'::uuid, 'en', 'c3d4e5f6-a7b8-9012-cdef-123456789012'::uuid, now() - interval '18 days', NULL, now() - interval '18 days', 'video'),
  ('10000000-0000-0000-0000-000000000004'::uuid, 'https://open.spotify.com/track/4uLU6hMCjMI75M1A2tKUQC', NULL, 'Bohemian Rhapsody', NULL, 'd4e5f6a7-b8c9-0123-defa-234567890123'::uuid, 'en', 'd4e5f6a7-b8c9-0123-defa-234567890123'::uuid, now() - interval '17 days', NULL, now() - interval '17 days', 'link'),
  ('10000000-0000-0000-0000-000000000005'::uuid, 'https://open.spotify.com/album/6DEjYFkNZh67HP7R9PSZvv', NULL, 'Rumours - Fleetwood Mac', NULL, 'e5f6a7b8-c9d0-1234-efab-345678901234'::uuid, 'en', 'e5f6a7b8-c9d0-1234-efab-345678901234'::uuid, now() - interval '16 days', NULL, now() - interval '16 days', 'link'),
  ('10000000-0000-0000-0000-000000000006'::uuid, 'https://www.nytimes.com/2024/01/15/technology/ai-future.html', NULL, 'The Future of AI - NYT', NULL, 'f6a7b8c9-d0e1-2345-fabc-456789012345'::uuid, 'en', 'f6a7b8c9-d0e1-2345-fabc-456789012345'::uuid, now() - interval '15 days', NULL, now() - interval '15 days', 'link'),
  ('10000000-0000-0000-0000-000000000007'::uuid, 'https://www.theguardian.com/science/2024/jan/20/space-exploration', NULL, 'Space Exploration in 2024', NULL, 'a7b8c9d0-e1f2-3456-abcd-567890123456'::uuid, 'en', 'a7b8c9d0-e1f2-3456-abcd-567890123456'::uuid, now() - interval '14 days', NULL, now() - interval '14 days', 'link'),
  ('10000000-0000-0000-0000-000000000008'::uuid, 'https://arstechnica.com/gadgets/2024/01/review-latest-smartphone/', NULL, 'Latest Smartphone Review', NULL, 'b8c9d0e1-f2a3-4567-bcde-678901234567'::uuid, 'en', 'b8c9d0e1-f2a3-4567-bcde-678901234567'::uuid, now() - interval '13 days', NULL, now() - interval '13 days', 'link'),
  ('10000000-0000-0000-0000-000000000009'::uuid, NULL, 'Recipe: 2 1/4 cups flour, 1 cup butter, 3/4 cup sugar, 2 eggs, 2 cups chocolate chips. Bake 375F 12 min.', 'Cookie Recipe', NULL, 'c9d0e1f2-a3b4-5678-cdef-789012345678'::uuid, 'en', 'c9d0e1f2-a3b4-5678-cdef-789012345678'::uuid, now() - interval '12 days', NULL, now() - interval '12 days', 'text'),
  ...
  ('10000000-0000-0000-0000-000000000011'::uuid, NULL, 'Idea: Platform connecting remote workers with cafes that have great WiFi. Membership model.', 'Remote Work Cafe Platform', NULL, 'e1f2a3b4-c5d6-7890-efab-901234567890'::uuid, 'en', 'e1f2a3b4-c5d6-7890-efab-901234567890'::uuid, now() - interval '10 days', NULL, now() - interval '10 days', 'text'),
  ('10000000-0000-0000-0000-000000000012'::uuid, 'https://github.com/facebook/react', NULL, 'React GitHub Repository',              NULL, 'f2a3b4c5-d6e7-8901-fabc-012345678901'::uuid, 'en', 'f2a3b4c5-d6e7-8901-fabc-012345678901'::uuid, now() - interval '9 days',  NULL, now() - interval '9 days', 'link'),
  ('10000000-0000-0000-0000-000000000013'::uuid, 'https://www.ted.com/talks/simon_sinek_how_great_leaders_inspire_action', NULL, 'TED: Start with Why', NULL, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, 'en', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid, now() - interval '8 days',  NULL, now() - interval '8 days', 'link'),
  ('10000000-0000-0000-0000-000000000014'::uuid, 'https://www.notion.so/templates', NULL, 'Notion Templates Gallery',             NULL, 'b2c3d4e5-f6a7-8901-bcde-f12345678901'::uuid, 'en', 'b2c3d4e5-f6a7-8901-bcde-f12345678901'::uuid, now() - interval '7 days',  NULL, now() - interval '7 days', 'link'),
  ('10000000-0000-0000-0000-000000000015'::uuid, NULL, 'Japan itinerary: Tokyo (3d) -> Kyoto (2d) -> Osaka (2d). Budget ~$2000pp.', 'Japan Trip Notes',                    NULL, 'c3d4e5f6-a7b8-9012-cdef-123456789012'::uuid, 'en', 'c3d4e5f6-a7b8-9012-cdef-123456789012'::uuid, now() - interval '6 days',  NULL, now() - interval '6 days', 'text'),
  ('10000000-0000-0000-0000-000000000016'::uuid, NULL, 'Q1 review: 85% done. 3 engineers approved. Next all-hands Thursday.', 'Product Team Meeting Notes',          NULL, 'd4e5f6a7-b8c9-0123-defa-234567890123'::uuid, 'en', 'd4e5f6a7-b8c9-0123-defa-234567890123'::uuid, now() - interval '5 days',  NULL, now() - interval '5 days', 'text'),
  ('10000000-0000-0000-0000-000000000017'::uuid, NULL, 'Podcasts: Lex Fridman x Sam Altman, How I Built This Airbnb, Tim Ferriss x Naval.', 'Podcast Picks',          NULL, 'e5f6a7b8-c9d0-1234-efab-345678901234'::uuid, 'en', 'e5f6a7b8-c9d0-1234-efab-345678901234'::uuid, now() - interval '4 days',  NULL, now() - interval '4 days', 'text'),
  ('10000000-0000-0000-0000-000000000018'::uuid, 'https://www.figma.com/community', NULL, 'Figma Community Resources',            NULL, 'f6a7b8c9-d0e1-2345-fabc-456789012345'::uuid, 'en', 'f6a7b8c9-d0e1-2345-fabc-456789012345'::uuid, now() - interval '3 days',  NULL, now() - interval '3 days', 'link'),
  ('10000000-0000-0000-0000-000000000019'::uuid, NULL, 'useEffect cleanup: return () => subscription.unsubscribe(); inside useEffect.', 'React useEffect Pattern',    NULL, 'a7b8c9d0-e1f2-3456-abcd-567890123456'::uuid, 'en', 'a7b8c9d0-e1f2-3456-abcd-567890123456'::uuid, now() - interval '2 days',  NULL, now() - interval '2 days', 'text'),
  ('10000000-0000-0000-0000-000000000020'::uuid, 'https://www.coursera.org/learn/machine-learning', NULL, 'Coursera ML Course',  NULL, 'b8c9d0e1-f2a3-4567-bcde-678901234567'::uuid, 'en', 'b8c9d0e1-f2a3-4567-bcde-678901234567'::uuid, now() - interval '1 day',   NULL, now() - interval '1 day', 'link');
