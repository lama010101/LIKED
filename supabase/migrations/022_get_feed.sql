-- ============================================================
-- Migration 022 — Canonical get_feed function (P9-T06-FIX)
-- ============================================================
-- Implements the master feed query per 04_FEED_SQL_SPEC.md §2.
-- This is the SINGLE source of truth for all feed results.
--
-- Pipeline order (non-negotiable):
--   nodes → visibility → context → block → view → filters → search → cursor → ordering → dedup → limit
--
-- Replaces:
--   get_visible_nodes (migration 020) — kept for non-feed usage
--   search_nodes (migration 021) — kept for non-feed usage
--   get_nodes_in_folder (migration 016) — kept for non-feed usage
-- ============================================================
...
GRANT EXECUTE ON FUNCTION get_feed(
  UUID, TEXT, TEXT, UUID, UUID, UUID, UUID[], UUID[], UUID[], TEXT, TEXT, TIMESTAMPTZ, UUID, INTEGER
) TO authenticated;
...
-- ============================================================
-- Performance indexes per 04_FEED_SQL_SPEC.md §6
-- ============================================================
...
-- pg_trgm extension already created in migration 021
