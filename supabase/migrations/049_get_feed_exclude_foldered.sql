-- ============================================================
-- Migration 049 — Exclude foldered nodes from root feed (STAB-01 FIX 1)
-- ============================================================
-- Adds p_exclude_foldered parameter to get_feed function.
...
CREATE OR REPLACE FUNCTION get_feed(
  ...
  -- STAB-01: Exclude foldered nodes from root feed
