-- ============================================================
-- Migration 055 — FIX-AUDIT-02: Add top-level EXCEPTION block to create_node_with_metadata
-- ============================================================
--
-- Changes:
-- 1. Add top-level EXCEPTION WHEN OTHERS THEN RAISE block for atomicity
-- 2. Preserve all existing logic and nested unique_violation handler
--
-- Ref: LIKED / FIX-AUDIT-02
