-- ============================================================
-- Migration 056 — FIX-AUDIT-03: Add top-level EXCEPTION blocks to RPCs
-- ============================================================
--
-- Changes:
-- 1. Add top-level EXCEPTION WHEN OTHERS THEN RAISE block to direct_share
-- 2. Add top-level EXCEPTION WHEN OTHERS THEN RAISE block to group_share
-- 3. Add top-level EXCEPTION WHEN OTHERS THEN RAISE block to group_unshare
